class TransCol < ActiveRecord::Migration[5.0]
  def change
  	...
  	add_column :transportations, :amount, :decimal{6,2}
  	add_column :transportations, :airfare, :decimal{6,2}
  	add_column :transportations, :rental_car, :decimal{6,2}
  	add_column :transportations, :bus_train, :decimal{6,2}
  end
end
